...
int main(void)
{
    ...
    fprintf(fout_v, " * \n");
    fprintf(fout_v, " * Copyright (c) 2003-2004 Lukasz Dembinski <dembol@linux.net>\n");
    ...
    fprintf(fout_v, " * Contact:	mailto: <dembol@linux.net>\n");
    fprintf(fout_v, " * \n");
    fprintf(fout_v, " */\n\n");
    ...
    fprintf(fout_d, " * \n");
    fprintf(fout_d, " * Copyright (c) 2003-2004 Lukasz Dembinski <dembol@linux.net>\n");
    ...
    fprintf(fout_d, " * Contact:	mailto: <dembol@linux.net>\n");
    fprintf(fout_d, " * \n");
    fprintf(fout_d, " */\n\n");
