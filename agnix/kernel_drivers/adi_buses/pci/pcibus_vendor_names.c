/* 
 * kernel_drivers/adi_buses/pci/pcibus_vendor_names.c
 * 
 ...
 * Info:	pcibus_vendor_names.c core file
...
struct pcibus_vendor_name_s pcibus_vendor_names[] = {
	...
	{ 0x1000, "LSI Logic / Symbios Logic (formerly NCR)" }, 
	{ 0x1001, "Initio" }, 
